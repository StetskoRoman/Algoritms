...
//        ArrayList<Integer> res = countWays(workMatrix, 1, 1, 1, visited, resList, 0);
        ArrayList<int[]> ways = new ArrayList<>();
        ArrayList<Integer> res = countWays(workMatrix, 1, 1, 1, visited, resList, 0, ways);
    ...
    static ArrayList<Integer> countWays(int[][] mat, int currentPoint, int previous, int targetPoint, ArrayList<Boolean> visited, ArrayList<Integer> res, int sum, ArrayList<int[]> ways) {
...
//        System.out.println("current point na vhode = " + currentPoint);
        ...
        for (int j = currentPoint; j < mat.length; j++) {
            if (j == currentPoint) {
                continue;
            }
...
//                System.out.println("sum before = " + sum);
                ...
                ways.add(new int[]{currentPoint, j, mat[currentPoint][j]});

                System.out.println("otkuda + kuda " + currentPoint + "    " + j + "   skok length  " + mat[currentPoint][j] + "   sum = " + sum);
//                System.out.println("sum after " + sum);
                ...
                if (!visited.contains(false)) {
                    ...
                    System.out.println("Visited in the end   " + visited);
...
//                    System.out.println("result here = " + result);
                    ...
                    ways.add(new int[]{currentPoint, targetPoint, result});
                    res.add(sum);
//                    System.out.println("print result " + res);
                    return res;
                }

                countWays(mat, currentPoint, previous, targetPoint, visited, res, sum, ways);
...
//            }
        ...
        for (int i = 0; i < ways.size(); i++) {
            System.out.println("ways = " + Arrays.toString(ways.get(i)));
        }
...
//    static ArrayList<Integer> countWays(int[][] mat, int currentPoint, int previous, int targetPoint, ArrayList<Boolean> visited, ArrayList<Integer> res, int sum) {
////        System.out.println(visited);
////        System.out.println("current point na vhode = " + currentPoint);
//
//        int beforeCurrent = currentPoint;
