...
public class Task4ClearChange {

    private static int sumFeed = 0;
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("mainlist = " + mainList + "   mates calculated and sorted = " + pairResList);

//        Set<Pair> pairSet = solution(pairResList, gw);
        Set<Integer> integerSet = solution(pairResList, gw);
        Integer maxInterest = Collections.max(integerSet);
        System.out.println("res = " + maxInterest);
//        System.out.println(pairSet);
//        System.out.println("victory = " + Collections.max(pairSet));
//        System.out.println("Max inter = " + findMaxInterest(pairSet));
    }

    static Set<Integer> solution(List<Pair> pairResList, int g) {

        Set<Pair> resList = new LinkedHashSet<>();
...
//                resList.add(pair);
                ...
                System.out.println("add pair " + pair + resList);
            } else continue;

            if (i == lastPoint) {

                System.out.println("lastpoint dost " + i + "  reslist = " + resList + "  " + pairResList.size());
                break;
            }
                for (int j = lastPoint; j > i; j--) {
                    System.out.println("cur point = " + i + "  last point = " + lastPoint);
...
//                        resList.add(pair);
        ...
        System.out.println("set Int = " + resSetInt);
